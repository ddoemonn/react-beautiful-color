...
<Tabs items={['npm', 'yarn', 'pnpm', 'bun']}>
  <Tab value="npm">```bash npm install react-beautiful-color ```</Tab>

{' '}
<Tab value="yarn">```bash yarn add react-beautiful-color ```</Tab>

{' '}
<Tab value="pnpm">```bash pnpm add react-beautiful-color ```</Tab>

  <Tab value="bun">```bash bun add react-beautiful-color ```</Tab>
</Tabs>
...
<Tabs items={['useColorState', 'useState']}>
<Tab value='useColorState'>
```tsx
