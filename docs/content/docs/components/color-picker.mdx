...
<Tabs items={['Preview', 'Code', 'Code without hook']}>
  <Tab value="Preview">
...
|------|------|---------|-------------|
| `defaultColor` | [ColorInput](/docs/components/color-picker#color-input-format) \| [Color](/docs/utils#color-class) | - | Initial color value |
| `color` | [ColorInput](/docs/components/color-picker#color-input-format) \| [Color](/docs/utils#color-class) | - | Color value |
